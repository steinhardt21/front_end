            ...
            <Container fluid id="background-about-us-svg">
                ...
                <Row>
                    <div className="col-md-3 offset-md-2 col-10 offset-1 shadow" id='containerFormCreateProject'>
                        <Row>
                            <div style={{overflow: "hidden", borderRadius: "36px"}} className="col-10 offset-1 col-md-12 offset-md-0 p-0"> <Image src={Image_1} width="auto" height='290px' style={{ borderRadius: '10%' }} /></div>
                        </Row>
                        <Row className="pt-5">
                    ...
                    <div className="col-md-3 offset-md-2 col-10 offset-1 shadow" id='containerFormCreateProject'>
                        <Row>
                            <div style={{overflow: "hidden", borderRadius: "36px"}} className="col-10 offset-1 col-md-12 offset-md-0 p-0"> <Image src={Image_2} width="auto" height='290px' style={{ borderRadius: '10%' }} /></div>
                        </Row>
                        <Row className="pt-5">
